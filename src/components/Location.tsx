...
const GOOGLE_MAPS_URL = 'https://maps.app.goo.gl/2ifFeCkTfX9ssapd7';
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 lg:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        {/* Flex layout — column on small screens, row on large */}
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative overflow-hidden rounded-3xl border border-[#FFD700]/20 shadow-[0_0_70px_-20px_rgba(255,215,0,0.45)]">
              <img
                src="/call2.jpg"
                alt="Funbi Bandele"
                className="h-[400px] w-full object-cover sm:h-[480px] xl:h-[620px]"
                loading="lazy"
              />
