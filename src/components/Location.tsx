...
const GOOGLE_MAPS_URL =
  'https://www.google.com/maps/place/Ulvh%C3%A4lls+Herrg%C3%A5rd/@59.3694996,17.2077076,15z';
...
const Location = () => {
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 lg:py-28">
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-12 px-4 sm:px-6 lg:flex-row lg:items-center lg:gap-16">
        {/* Text Content */}
        <div className="w-full max-w-xl space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <a
              ...
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 rounded-xl border border-[#FFD700]/40 bg-black/60 px-5 py-3 text-sm sm:text-base font-medium tracking-wider text-[#FFD700] transition-all duration-300 hover:border-[#FFD700] hover:bg-[#FFD700]/20"
              aria-label="Open Ulvhälls Herrgård on Google Maps in a new tab"
            >
