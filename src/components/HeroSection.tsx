...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6">
      <div className="absolute inset-0 bg-gradient-to-br from-[#FFF8E1] via-[#FFF3E0] to-[#FFECB3]">
        <div className="absolute inset-0 bg-gradient-to-b from-[#FFD700]/20 via-transparent to-transparent opacity-40"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <div className="relative inline-block animate-fade-in">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#FFD700] to-[#DC143C] opacity-40 blur-xl"></div>
            ...
            <div className="animate-fade-in-delayed">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light font-serif flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-2 sm:gap-3 lg:gap-6">
                ...
                <span className="text-lg sm:text-xl lg:text-2xl text-[#DC143C]/70">&</span>
                <span className="relative group">
            ...
            <div className="space-y-3 sm:space-y-4 animate-fade-in-delayed">
              <div className="h-px w-24 sm:w-32 lg:w-40 mx-auto lg:mx-0 bg-gradient-to-r from-transparent via-[#DC143C] to-transparent"></div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-light tracking-[0.2em] text-[#DC143C]/90 uppercase">
            ...
            <div className="space-y-6 sm:space-y-8 animate-fade-in-delayed">
              <div className="space-y-2 sm:space-y-4">
                <p className="text-base sm:text-lg lg:text-xl text-[#DC143C]/80 font-light tracking-wide max-w-lg mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 lg:gap-6">
                <div className="group w-full sm:w-auto flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-lg px-4 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-full border border-[#DC143C]/20 hover:border-[#DC143C]/40 transition-all duration-500 shadow-lg">
                  <Calendar className="text-[#DC143C] transition-transform group-hover:scale-110 duration-300 min-w-[20px] sm:min-w-[24px]" size={20} />
                  <span className="text-sm sm:text-base lg:text-lg font-light text-[#DC143C]/90 tracking-wider whitespace-nowrap">December 2025</span>
                </div>
                <div className="group w-full sm:w-auto flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-lg px-4 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-full border border-[#DC143C]/20 hover:border-[#DC143C]/40 transition-all duration-500 shadow-lg">
                  <MapPin className="text-[#DC143C] transition-transform group-hover:scale-110 duration-300 min-w-[20px] sm:min-w-[24px]" size={20} />
                  <span className="text-sm sm:text-base lg:text-lg font-light text-[#DC143C]/90 tracking-wider">Surulere, Lagos</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6 justify-center lg:justify-start">
                <a
                  href="/rsvp"
                  className="w-full sm:w-auto group relative px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 overflow-hidden rounded-full bg-gradient-to-r from-[#FFD700] to-[#DC143C] text-white transform hover:scale-105 transition-all duration-500 shadow-lg"
                >
                ...
                <a
                  href="/gallery"
                  className="w-full sm:w-auto group px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 rounded-full text-sm sm:text-base lg:text-lg font-medium tracking-wider text-[#DC143C] border border-[#DC143C]/30 hover:border-[#DC143C] bg-white/80 backdrop-blur-lg transition-colors duration-500 transform hover:scale-105 shadow-lg"
                >
                  View Gallery
                </a>
              </div>
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-delayed">
            <div className="relative group">
              {/* Image Container */}
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-white/50">
                <img
      ...
      <div className="absolute bottom-4 sm:bottom-8 lg:bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-[#DC143C]/30 rounded-full flex justify-center bg-white/80 backdrop-blur-lg shadow-lg">
          <div className="w-1 h-2 sm:h-3 bg-[#DC143C] rounded-full mt-1 sm:mt-2 animate-pulse"></div>
        </div>
      </div>
    </section>
  );
