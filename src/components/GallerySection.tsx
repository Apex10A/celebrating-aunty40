...
export const GallerySection = () => {
  return (
    <section id="gallery" className="py-16 sm:py-32 px-4 sm:px-6 bg-[#0a0a0a] relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {galleryImages.map((image, index) => (
            <div
              key={index}
              className="group relative aspect-square overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-700 cursor-pointer fade-in"
            >
              <img
                src={image}
